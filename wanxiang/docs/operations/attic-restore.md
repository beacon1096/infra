...
2. **RS256 keypair rotation — the nuclear option.** Rotating the
   ...
   1. Generate a new RS256 keypair according to the archived private
      Attic contract. `openssl genpkey -algorithm RSA …` — PKCS#8.
...
The archived acceptance test SC-006 ("old token → 401") is satisfied
either by waiting out
