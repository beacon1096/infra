# Thor: system and firmware

[Thor overview](../thor.md)

Jetson AGX Thor T5000 (SM110). Model-specific runtime and performance
observations are recorded in the [model index](../thor.md#model-experiments).

## Declarative configuration

- [Host configuration](../../hosts/personal/fixed/thor/configuration.nix):
