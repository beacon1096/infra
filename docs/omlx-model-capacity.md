...
| --- | --- | ---: | ---: | ---: |
| Qwen3.8-27B dense | M4 | 待长输入验证 | 32K | 8K |
| Qwen3.6-27B dense（保留回退） | M4 | 8–16K | 32K | 8K |
| Gemma-4-31B dense | M4 | 输入约 6K 内 | 8K | 2K |
| Gemma-4-E4B | M4 | 32–64K | 128K | 8–16K |

oMLX 0.6.4 与固定 revision 的 Qwen3.8-27B 4-bit 已在 M4 完成短请求推理验证，Gemma E4B 回归请求也通过；32K 长上下文尚未压测。旧 Qwen3.6 权重保持隐藏并保留回退，网关和客户端模型名尚未切换。
